...
alias cod='codex --dangerously-bypass-approvals-and-sandbox --model gpt-5.6-sol -c model_reasoning_effort="ultra" -c plan_mode_reasoning_effort="ultra" -c model_reasoning_summary_format=experimental'
